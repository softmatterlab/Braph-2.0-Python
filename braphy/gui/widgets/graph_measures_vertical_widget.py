...
ui_file = abs_path_from_relative(__file__, "../ui_files/graph_measures_vertical_widget.ui")
Form, Base = uic.loadUiType(ui_file)

class GraphMeasuresVerticalWidget(Base, Form):
    def __init__(self, parent = None):
        super(GraphMeasuresVerticalWidget, self).__init__(parent)
        self.setupUi(self)
