...
class TestBrainAtlas(TestUtility):
    def test_1(self):
        ...
        self.assertSequenceEqual(atlas.get_brain_region_labels().tolist(), ['BR_11', 'BR8', 'BR1', 'BR3', 'BR7', 'BR_10', 'BR4', 'BR9', 'BR1'])
        ...
        self.assertSequenceEqual(atlas.get_brain_region_labels().tolist(), ['BR_11', 'BR8', 'BR1', 'BR_13', 'BR3', 'BR7', 'BR_10', 'BR4', 'BR9', 'BR1', 'BR_12'])
    ...
    def test_move_up_2(self):
        ...
        self.assertSequenceEqual(atlas.get_brain_region_labels().tolist(), ['BR2', 'BR1', 'BR3'])
    ...
    def test_move_down_1(self):
        ...
        self.assertSequenceEqual(atlas.get_brain_region_labels().tolist(), ['BR3', 'BR1', 'BR2'])
