...
class TestModularity(unittest.TestCase):
    def test_modularity_1(self):
        ...
        self.assertAlmostEqual(graph.measure_dict[MeasureModularity]['modularity'], 0, places = 4)
    ...
    def test_modularity_2(self):
        ...
        graph = GraphBU(A, measure_list[GraphBU], 'zero', 'max')
        MeasureModularity.compute_measure(graph)
        self.assertAlmostEqual(graph.measure_dict[MeasureModularity]['modularity'], 5.5511e-17, places = 4)
    ...
    def test_modularity_3(self):
        ...
        MeasureModularity.compute_measure(graph)
        self.assertAlmostEqual(graph.measure_dict[MeasureModularity]['modularity'], 0.5, places = 4)
